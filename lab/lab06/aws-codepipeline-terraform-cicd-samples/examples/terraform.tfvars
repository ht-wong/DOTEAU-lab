...
environment        = "dev"
source_repo_name   = "[YOUR_REPO_NAME]"
source_repo_branch = "main"
create_new_repo    = true
repo_approvers_arn = "arn:aws:sts::[YOUR_ACCOUNT_ID]:assumed-role/CodeCommitReview/*" #Update ARN (IAM Role/User/Group) of Approval Members
